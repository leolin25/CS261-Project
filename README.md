...
If working on the project create a new branch (copy of main) and edit the branch instead of working on the main branch. This is to prevent errors and overlapping in the main branch.
